...
\item Wrote a LabView application to servo the RF current in a lower Q resonant LC system to calibrated levels.
\item Built a higher Q resonant LC system with a parallel plate capacitor for RF displacement current calibration.
\item Designed a matching network and power amplifier to drive the higher Q resonant system.
