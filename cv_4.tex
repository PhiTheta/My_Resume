...
\item Tuned cascaded control loops to get the system to each set point.
\end{rWorkProject}
...
\itemsep -0.5em \vspace{-0.5em}
\renewcommand{\labelitemi}{-}
\item Calibrated the data, and corrected for intrinsic sensor offset
\item Automatically identified features in the data in order to parse it
