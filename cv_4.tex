...
Lab Skills & Oscilloscope, Network Analyzer, Multimeter, 4Wire LCR Meter \\
& Root Cause Analysis, SMD Soldering, Prototyping \smallskip \\
...
\item Adapted existing embedded system firmware and hardware for use with new sensor types.
\item Designed, tested, and realized custom RFID systems for use in ultra low power embedded applications.
\item Worked with a team to design a new embedded system architecture to lower power consumption, improve measurement accuracy, increase system flexibility, and increase product reliability.
\end{itemize}
